...
[lowd_create.py](): Creating low dimensional representation of signal frames
[gmm_model_fit.py](): The implemented algorithm is a supervised learning algorithm. During training we estimate the parameters of the
GMMs that model the first three dominant eigen vectors of the normalized Laplacian matrix.
[test.py](): During testing, likelihood ratio of the new frame w.r.t two GMMs is found. With appropriately chosen threshold, the label for the frame is assigned.
